...
import rafael.alcocer.caldera.kafka.swing.workers.CreateTopicWorker;

public class CreateTopicActionListener implements ActionListener {

    private final KafkaFrame kafkaFrame;

    public CreateTopicActionListener(KafkaFrame kafkaFrame) {
        this.kafkaFrame = kafkaFrame;
    }

    public void actionPerformed(ActionEvent e) {
        CreateTopicWorker createTopicWorker = new CreateTopicWorker(kafkaFrame);
        createTopicWorker.execute();
    }
}
