...
import rafael.alcocer.caldera.kafka.swing.service.TopicService;
import rafael.alcocer.caldera.kafka.swing.service.TopicServiceImpl;
...
public class TopicControllerImpl implements TopicController {
    ...
    public CreateTopicsResult createTopic(String topicName, int numPartitions, short replicationFactor) {
        return topicService.createTopic(topicName, numPartitions, replicationFactor);
    }
