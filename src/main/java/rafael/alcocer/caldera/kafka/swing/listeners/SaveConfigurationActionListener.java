...
import rafael.alcocer.caldera.kafka.swing.workers.SaveConfigurationWorker;

public class SaveConfigurationActionListener implements ActionListener {

    private final KafkaFrame kafkaFrame;

    public SaveConfigurationActionListener(KafkaFrame kafkaFrame) {
        this.kafkaFrame = kafkaFrame;
    }

    public void actionPerformed(ActionEvent e) {
        SaveConfigurationWorker worker = new SaveConfigurationWorker(kafkaFrame);
        worker.execute();
    }
}
